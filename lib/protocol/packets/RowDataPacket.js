    ...
    case Types.NEWDATE:
      ...
      if (dateStrings) {
          if (field.type === Types.DATE) {
              return dateString; // Any truthy value for dateStrings returns dateString for DATE type field
          } else if (dateStrings.toString().toLowerCase() !== "date") {
              return dateString; // If the truthy value is NOT "date" return dateString for all other field types
          }
      }
