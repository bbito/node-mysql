...
function typeCast(field, parser, timeZone, supportBigNumbers, bigNumberStrings, dateStrings) {
  ...
  switch (field.type) {
    ...
    case Types.NEWDATE:
      ...
      // bbito - Adding checks to allow true OR "DATE" as dateStrings values
      //       - "DATE" should only effect DATE fields whereas true retains
      //       - original behavior.
      //if (dateStrings) {
      if (dateStrings === true || dateStrings === "DATE" && field.type === Types.DATE) {
          return dateString;
      }
      var dt;
